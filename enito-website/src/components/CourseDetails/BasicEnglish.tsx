...
//   ];
 ...
 const whatsappNumber = "919496687327";
  ...
  const handleBeginJourney = () => {
     const message = "Hello ENITO, I'm interested in learning Basic English";
        ...
        <main className="main-content">
          ...
          <section className="overview-section">
            <div className="overview-text">
             ...
             Basic English is a spoken English course designed for beginners starting their learning journey. Available in both one to one and group formats, it offers flexibility based on your comfort and learning style.
              </p>
               
              <p className="overview-description">
 The course focuses on essential vocabulary, simple phrases, and basic sentence structures used in everyday situations. Through guided practice and interactive activities, it helps you build confidence, improve communication skills, and start speaking English from day one            </p>
            </div>
...
By the end of the course, you will be able to use simple English in everyday situations and speak with greater ease and confidence.
  ...
  <div className="footer-content">
    ...
    <div className="footer-left">
      ...
      {/* 📞 Phone */}
    <div className="footer-contact" onClick={handlePhoneCallss} style={{ cursor: 'pointer' }}>
                 <Phone size={16} />
    ...
    <div className="footer-social">
      <a
        href={`https://wa.me/${whatsappNumber}?text=Hello%20ENITO%2C%20I'm%20interested%20in%20learning%20Basic%20English`}
        target="_blank"
