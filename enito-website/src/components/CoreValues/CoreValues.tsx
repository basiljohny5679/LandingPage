  ...
  const values = [
    {
      ...
      iconClass: "icon-orange",
      title: "Speak with Confidence",
      short: "Practical speaking skills",
      full: "We help learners express themselves clearly and confidently in English. Through real conversations, encouragement, and practical learning, you gain the courage to speak with confidence & clarity."
    },
    {
      icon: "❤️",
      iconClass: "icon-blue",
      title: "Learn with Trust",
      short: "Honest and safe guidance",
      full: "At ENITO, learning happens in a safe and respectful space. With honest guidance and support, every learner feels comfortable asking questions, making mistakes, and improving step by step."
    },
    {
      icon: "👥",
      iconClass: "icon-teal",
      title: "Lets Grow Together",
      short: "Supportive community",
      full: "We are more than a classroom—we are a supportive learning community. Here, learners practice together, encourage one another, and grow in confidence as a team."
    }
  ];
        ...
        <div className="values-grid">
          {values.map((value, idx) => (
            <div key={idx} className="value-card">
              ...
              <div className={`icon-box ${value.iconClass}`}>
                {value.icon}
              </div>
              ...
              <p className="value-desc">
                {openIndex === idx ? value.full : value.short}
              </p>
              ...
              >
                {openIndex === idx ? "Show Less ↑" : "Read More ↓"}
              </button>
